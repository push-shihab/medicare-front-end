...
export default function HeroSectionClient({ avgRating, doctors, patients }) {
  return (
          ...
          <div className="flex flex-col items-start gap-6 lg:col-span-7">
            ...
            >
              {[
                ...
                { value: `${patients.length}+`, label: "Patients" },
                { value: avgRating.toFixed(2), label: "Rating", star: true },
              ].map((stat, i) => (
